...
public class SimpleDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_DATA_TABLE_CLOUD
            = "create table " + "cloud" + "(id integer primary key autoincrement, name text, time text, date text)";
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            ...
            sqLiteDatabase.execSQL(CREATE_DATA_TABLE_CLOUD);
        }
